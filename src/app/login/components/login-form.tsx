  ...
  return (
    <div className={cn("flex flex-col gap-6", className)} {...props}>
          ...
          <form className="p-6 md:p-8">
            <div className="flex flex-col gap-6">
              ...
              <div className="grid gap-2">
                <div className="flex items-center">
                  ...
                  <a
                    ...
                    className="ml-auto text-sm text-[#FF9900] hover:text-[#e88900] underline-offset-2 hover:underline"
                  >
              ...
              <div className="grid grid-cols-3 gap-4">
                <Button
                  variant="outline"
                  className="w-full border-slate-300 hover:border-[#FF9900] hover:bg-orange-50 bg-transparent"
                >
            ...
            <div className="absolute inset-0 flex items-center justify-center p-8">
              <div className="text-center text-white">
                ...
                <p className="text-lg opacity-90">
                  Optimize your Amazon business with intelligent insights and automation
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="text-balance text-center text-xs text-slate-500 [&_a]:underline [&_a]:underline-offset-4 hover:[&_a]:text-[#FF9900]">
        ...
        <a href="#" className="text-[#FF9900] hover:text-[#e88900]">
          Terms of Service
        </a>{" "}
        and{" "}
        <a href="#" className="text-[#FF9900] hover:text-[#e88900]">
